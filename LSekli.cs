...
namespace TetrisProje
{
    class LSekli:Sekil
    {
        ...
        { 
            if(kareler[1].Noktalar[1].X/20+2>20)
                return;
            if (oyunAlani[kareler[1].Noktalar[1].X / 20, kareler[1].Noktalar[1].Y / 20] == true )
                return;
            if (oyunAlani[kareler[1].Noktalar[1].X / 20+1, kareler[1].Noktalar[1].Y / 20] == true )
                return;

            kareler[0].konumlandır(kareler[1].Noktalar[1].X, kareler[1].Noktalar[1].Y);
            kareler[3].konumlandır(kareler[1].Noktalar[1].X+20, kareler[1].Noktalar[1].Y);
            durum = 1;
        }
        private void donus2(bool[,] oyunAlani)
        {
            ...
            kareler[0].konumlandır(kareler[1].Noktalar[0].X -20,
            kareler[1].Noktalar[0].Y-20 );
            kareler[3].konumlandır(kareler[1].Noktalar[0].X , kareler[1].Noktalar[0].Y -20);
            durum = 2;
        }
        private void donus3(bool[,] oyunAlani)
        {
            if (kareler[2].Noktalar[0].X - 40 < 0)
                return;
            if (oyunAlani[kareler[2].Noktalar[0].X / 20 - 1, kareler[2].Noktalar[0].Y/20] == true)
                return;
            if (oyunAlani[kareler[2].Noktalar[0].X / 20 - 2, kareler[2].Noktalar[0].Y/20] == true)
                return;
            kareler[0].konumlandır(kareler[2].Noktalar[0].X - 20, kareler[2].Noktalar[0].Y);
            kareler[3].konumlandır(kareler[2].Noktalar[0].X - 40, kareler[2].Noktalar[0].Y);
            durum = 3;

        }
        private void donus4(bool[,] oyunAlani)
        {
            if (kareler[2].Noktalar[1].X + 20 > 400)
                return;
